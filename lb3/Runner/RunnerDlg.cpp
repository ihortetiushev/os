...
void CRunnerDlg::DoDataTransfer()
{
	...
	CString hotKeyPressedText("Data transfer key is pressed. Doing nothing for now...");
	SetDlgItemTextW(STATUS_LABEL, hotKeyPressedText);
	Sleep(3000);
	hotKeyPressedText = "Waiting for user input";
	SetDlgItemTextW(STATUS_LABEL, hotKeyPressedText);
